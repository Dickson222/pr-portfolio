...
export default function Hero() {
  return (
    <section className="container-max hero">
      <div className="left">
        ...
        <div className="ctas">
          {/* <a href="/resume.pdf" download="Dickson_Godwin_Resume.pdf" className="btn btn-dark" aria-label="Download resume">Download resume</a> */}
      ...
      <div className="avatar-wrap" aria-hidden>
        <div className="avatar">
          <Image src={avatar} alt="avatar" width={144} height={144} />
        </div>
      </div>
    </section>
  );
